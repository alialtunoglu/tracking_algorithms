...
# x="class" ile "class" sütunu grafiğin x eksenine atanır. 
#Bu, her sınıfın frekansının sayıldığı ve görselleştirildiği bir grafik oluşturur.
#%%
...
id1 = 29 # takip edeceğimiz aracın identity numberı 
...
for i in range(numberOfImage-1):
    ...
    if ret:
        ...
        if len(car[filter_id1]) != 0:
            ...
            #Burada 2ye bölme sebebimiz görüntüyü yeniden boyutlandırdık ve 960x540 yaptık 
